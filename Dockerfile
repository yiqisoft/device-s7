...
WORKDIR /
COPY --from=builder /device-s7/cmd/device-s7/Attribution.txt /Attribution.txt
COPY --from=builder /device-s7/cmd/device-s7/device-s7 /device-s7
COPY --from=builder /device-s7/cmd/device-s7/res/ /res
